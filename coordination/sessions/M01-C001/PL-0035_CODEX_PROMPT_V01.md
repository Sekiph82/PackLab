# PL-0035 — Codex Child Work Order V01
...
Log: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0035_CODEX_LOG_V01.md
...
1. Run commands with argument arrays, captured exit code, stdout/stderr streaming callbacks and bounded resource ownership.
2. Support timeout and cancellation with child-process cleanup appropriate to Windows and portable fallbacks.
3. Never use shell=True by default and never concatenate untrusted command strings.
4. Return structured result/error information suitable for logging and future job orchestration.
5. Add tests for success, nonzero exit, stdout/stderr, timeout and cancellation without invoking heavy external engines.
