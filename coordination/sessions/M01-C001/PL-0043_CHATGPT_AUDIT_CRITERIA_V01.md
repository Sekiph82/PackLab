# PL-0043 — ChatGPT Strict Child Audit Criteria V01
...
8. Add a unit-test target to the Xcode project with at least one deterministic smoke test covering foundation code that does not require camera hardware is satisfied.
9. Keep test target free of signing secrets and personal team settings is satisfied.
10. Ensure the test can run on simulator/macOS CI once M16 provides the runner is satisfied.
11. Document what was statically verified now versus what requires xcodebuild on macOS is satisfied.
12. Do not claim physical-device or camera validation is satisfied.
...
17. Child log exists at https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0043_CODEX_LOG_V01.md and links the full prompt/criteria URLs.
...
Any failed mandatory criterion keeps PL-0043 open. A child failure does not erase already accepted earlier child audits, but M01 remains open.
