# PL-0031 — Codex Child Work Order V01
...
Log: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0031_CODEX_LOG_V01.md
...
1. Configure pytest discovery for the monorepo and markers for unit, integration and slow tests.
2. Keep default developer test execution fast by excluding slow tests unless requested.
3. Register markers so unknown-marker warnings fail or are prevented.
4. Document selection commands and CI intent without creating M16 workflows.
5. Add at least one marker smoke test or collection check proving configuration is active.
