# PL-0034 — Codex Child Work Order V01
...
Log: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0034_CODEX_LOG_V01.md
...
1. Represent optional capabilities such as CUDA, COLMAP, OpenMVS, Blender and OpenCascade as explicit available/unavailable/unknown states with provenance.
2. Separate executable discovery/version evidence from assumptions; absence must not crash unrelated PackLab features.
3. Do not infer CUDA from GPU brand/memory fields.
4. Do not select the deferred Python OCCT binding.
5. Add tests for available, unavailable, malformed-version and probe-error states.
