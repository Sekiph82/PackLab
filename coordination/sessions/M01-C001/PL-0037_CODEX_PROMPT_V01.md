# PL-0037 — Codex Child Work Order V01
...
Log: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0037_CODEX_LOG_V01.md
...
1. Pin NextLevel from the canonical NextLevel/NextLevel repository using an exact version or immutable revision in the Xcode project/package graph.
2. Verify current upstream package metadata/license and record the exact version/revision plus evidence date.
3. Keep NextLevel behind PackLab-owned camera-service boundaries and do not expose its API as the cross-platform contract.
4. Perform the strongest package-resolution/source compatibility check available without fabricating macOS/Xcode build evidence; record any platform limitation explicitly.
5. Do not add unrelated Swift dependencies.
