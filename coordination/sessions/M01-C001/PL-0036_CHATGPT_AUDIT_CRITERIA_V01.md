# PL-0036 — ChatGPT Strict Child Audit Criteria V01
...
8. Create a minimal native SwiftUI PackLab Capture project under apps/ios-capture with bundle/product naming clearly separated from Windows Studio is satisfied.
9. Target the owner baseline iPhone 16 Standard and document a minimum iOS version justified by product/device/upstream compatibility is satisfied.
10. Do not require LiDAR or Pro-only hardware is satisfied.
11. Keep project settings source-controlled and free of personal signing/team identifiers is satisfied.
12. Do not claim native Xcode build evidence from Windows; record what is statically validated and what requires macOS/Xcode later is satisfied.
...
17. Child log exists at https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0036_CODEX_LOG_V01.md and links the full prompt/criteria URLs.
...
Any failed mandatory criterion keeps PL-0036 open. A child failure does not erase already accepted earlier child audits, but M01 remains open.
