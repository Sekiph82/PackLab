# PL-0026 — ChatGPT Strict Remediation Audit Criteria V02

Repository: https://github.com/Sekiph82/PackLab
Prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0026_CODEX_PROMPT_V02.md
Prior audit evidence: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0026_CHATGPT_AUDIT_V01.md
...
8. Make Windows cache, temporary workspace, and durable project-data roots physically distinct so durable owner data is never beneath the logical cache root is satisfied.
9. Prefer sibling cache/work/data roots or another clearly separated platform-appropriate arrangement is satisfied.
10. Preserve macOS/Linux separation, explicit PACKLAB_CACHE_ROOT/PACKLAB_DATA_ROOT overrides, lazy creation and no automatic deletion is satisfied.
11. Add Windows regression tests proving project_data_root is neither equal to nor a descendant of cache_root and that tests use temporary paths only is satisfied.
12. Update documentation to match exact path semantics is satisfied.
...
19. Remediation log exists at https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0026_CODEX_LOG_V02.md and links prompt/criteria/audit evidence.
