# PL-0029 — Codex Child Work Order V01
...
Log: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M01-C001/PL-0029_CODEX_LOG_V01.md
...
- `docs/development/WINDOWS_BOOTSTRAP.md`
...
1. Choose a reproducible Python dependency-management/locking approach compatible with the pinned Python version and public/free tooling.
2. Create the lock/config files required by that choice and a Windows bootstrap script that validates prerequisites before installing.
3. Lock only dependencies actually authorized by M01; do not select the deferred Python OCCT binding.
4. Make bootstrap idempotent enough to rerun safely and fail clearly on version/tool mismatch.
5. Record exact tool/version provenance and license-sensitive package notes where relevant.
6. Do not embed credentials, absolute owner paths or private indexes.
