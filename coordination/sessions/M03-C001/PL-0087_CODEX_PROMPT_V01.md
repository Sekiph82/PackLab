# PL-0087 — Codex Work Order V01

Task: **PL-0087 — Implement New Scan wizard: package name, package type, capture mode and optional notes.**
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0087_CODEX_PROMPT_V01.md
Frozen criteria: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0087_CHATGPT_AUDIT_CRITERIA_V01.md
...
SwiftUI New Scan flow, validated draft model and tests.

## Mandatory requirements

1. Create a New Scan wizard collecting package name, package type, capture mode and optional notes with clear cancel/back/start behavior.
2. Use the accepted capture-mode contract from M02 and stable internal identifiers rather than only display strings.
3. Validate required fields, normalize safe text lengths and prevent starting a session from an invalid draft.
4. Produce a deterministic session draft/metadata object for PL-0088 storage without touching future guided-capture M04 logic.
5. Add view-model/model tests for valid/invalid inputs, cancellation and capture-mode mapping.
...
Commit the child implementation/evidence separately, publish https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0087_CODEX_LOG_V01.md, verify remote visibility, and end the child log exactly:
