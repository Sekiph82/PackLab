# PL-0082 — Codex Remediation Work Order V02
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0082_CODEX_PROMPT_V02.md
Frozen criteria: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0082_CHATGPT_AUDIT_CRITERIA_V02.md
Required log: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0082_CODEX_LOG_V02.md
...
1. Fail closed on wrong-size or non-finite transforms instead of silently converting invalid data to identity.
2. Add explicit inverse/round-trip support or an equivalent validated conversion round-trip.
3. Add golden tests for nontrivial translation, X/Y/Z axis rotations, composition, inverse and round-trip tolerance.
4. Prove PackScan coordinate convention, basis conversion and metre unit constants remain aligned with schemas/packscan/pose.schema.json.
