# PL-0087 — Codex Remediation Work Order V03
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0087_CODEX_PROMPT_V03.md
...
1. Make NewScanWizard use a testable workflow/view-model seam rather than duplicating validation logic separate from NewScanWorkflowModel.
2. Prove valid Start invokes the supplied onStart callback exactly once with the normalized draft.
3. Prove invalid Start never invokes onStart and retains visible validation state; prove Cancel never invokes Start.
4. Preserve root reachability and all accepted M02 capture-mode IDs, and pass the produced draft into the real session-creation handoff instead of discarding it.
