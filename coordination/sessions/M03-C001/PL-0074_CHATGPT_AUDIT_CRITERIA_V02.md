# PL-0074 — ChatGPT Remediation Audit Criteria V02
...
10. Route AVFoundation exposure configuration through the shared serialized CameraConfigurationCoordinator/session ownership path.
11. Bind exposure metering/lock state to the selected main camera and capture-ready state.
12. Persist actual exposure state/measurement into the accepted per-photo metadata flow.
13. Expose metering/locked/unavailable/failure state to the capture UI and test serialization, bounds, unsupported lock and metadata binding.
