# PL-0080 — Codex Work Order V01

Task: **PL-0080 — Record camera transform and tracking state aligned to capture timestamps.**
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0080_CODEX_PROMPT_V01.md
Frozen criteria: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0080_CHATGPT_AUDIT_CRITERIA_V01.md
...
AR frame sampling, timestamp alignment model, PackScan pose-ready records/tests.

## Mandatory requirements

1. Sample AR camera transform and AR tracking state with ARFrame timestamps using a documented timebase.
2. Associate the closest/appropriate pose sample with each accepted camera capture timestamp using explicit alignment/tolerance rules.
3. Record transform matrix, tracking-state classification and alignment delta without fabricating pose when AR data is absent or stale.
4. Keep coordinate semantics explicit and defer coordinate-frame conversion details to PL-0082.
5. Add deterministic alignment tests with synthetic timestamp streams including stale, missing and out-of-order samples.
...
Commit the child implementation/evidence separately, publish https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0080_CODEX_LOG_V01.md, verify remote visibility, and end the child log exactly:
