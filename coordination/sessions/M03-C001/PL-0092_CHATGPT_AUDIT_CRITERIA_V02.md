# PL-0092 — ChatGPT Remediation Audit Criteria V02
...
10. Build history entries by enumerating and validating authoritative local session/finalization records.
11. Add the actual SwiftUI local scan history screen using preview derivatives only.
12. Detect missing/corrupt preview or record data and retain a visible degraded entry rather than hiding it.
13. Define export/finalization state deterministically and test ordering, state transitions, missing preview and corrupt records.
