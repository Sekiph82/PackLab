# PL-0079 — ChatGPT Remediation Audit Criteria V02
...
10. Move the physical ARKit implementation behind the existing ARTrackingService seam rather than a parallel public ownership path.
11. Establish exactly one ARSession owner and prevent duplicate controller/session creation.
12. Preserve SimulatorARTrackingService .unavailable behavior under the same service contract.
13. Expose truthful running/limited/unavailable/interrupted state through the shared model and add lifecycle/capability tests against the service seam.
