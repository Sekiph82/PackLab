# PL-0091 — Codex Remediation Work Order V03
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0091_CODEX_PROMPT_V03.md
...
1. Complete preflight enforcement of M02 manifest/photo/source/checksum contract including checksum canonicalization and safe/unique payload-set semantics.
2. Add a real successful SessionFinalizer.finalize filesystem test and validate the resulting .packscan output path.
3. Add packaging/destination failure tests proving no valid-looking partial package remains and the working session remains unchanged/resumable.
4. Preserve distinct invalid-manifest, missing-photo, invalid-binding, checksum and packaging errors.
