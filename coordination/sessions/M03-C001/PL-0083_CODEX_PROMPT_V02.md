# PL-0083 — Codex Remediation Work Order V02
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0083_CODEX_PROMPT_V02.md
Frozen criteria: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0083_CHATGPT_AUDIT_CRITERIA_V02.md
Required log: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0083_CODEX_LOG_V02.md
...
1. Bind tracking degradation/recovery state to a visible capture warning/instruction in the real app view model/UI.
2. Add an explicit recovery stability/hysteresis policy before returning to pose-eligible normal state.
3. Persist/retain degradation diagnostics across state transitions rather than only computing ephemeral snapshots.
4. Add deterministic tests for rapid flapping, sustained recovery threshold, warning visibility and diagnostic retention.
