# PL-0088 — Codex Remediation Work Order V02
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0088_CODEX_PROMPT_V02.md
Frozen criteria: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0088_CHATGPT_AUDIT_CRITERIA_V02.md
Required log: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0088_CODEX_LOG_V02.md
...
1. Add a canonical per-photo-record layout and schema-compatible record persistence alongside metadata/state/images/previews/tmp.
2. Create one accepted-capture persistence workflow that safely writes immutable source + per-photo record + incremental session state.
3. Add reopen validation and stale-temp recovery/cleanup semantics for interrupted writes.
4. Add real temporary-directory/failure-injection tests for interrupted write, stale temp, duplicate IDs, successful reopen and corrupt/incomplete reopen.
