# PL-0072 — Codex Remediation Work Order V03
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0072_CODEX_PROMPT_V03.md
...
1. Extract HEIF/JPEG metadata from the original source bytes using ImageIO/CGImageSource rather than accepting opaque caller-provided metadata bytes as evidence.
2. Preserve safe EXIF/TIFF/unknown metadata while keeping the immutable master source unchanged.
3. Prove derivative generation cannot overwrite the master and enforce decoded pixel-dimension consistency.
4. Add tests for metadata extraction/preservation, unsupported/malformed source metadata, derivative overwrite protection and dimension mismatch.
