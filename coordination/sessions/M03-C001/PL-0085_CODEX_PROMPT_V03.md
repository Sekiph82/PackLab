# PL-0085 — Codex Remediation Work Order V03
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0085_CODEX_PROMPT_V03.md
...
1. Continuously refresh tracking, pose, motion and epoch while the capture runtime is active; do not leave the overlay at startup snapshots.
2. Feed epoch from the real reset/localization owner and motion from the unified MotionService.
3. Ensure updates stop with lifecycle and avoid unbounded/per-frame main-thread work.
4. Add view-model tests proving values change over time and simulator/unavailable state remains truthful.
