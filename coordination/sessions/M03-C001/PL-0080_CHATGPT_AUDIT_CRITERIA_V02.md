# PL-0080 — ChatGPT Remediation Audit Criteria V02

Task: **PL-0080 — AR pose sampling/alignment remediation**
Previous audit: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0080_CHATGPT_AUDIT_V01.md
...
10. Sample real ARFrame timestamp, camera transform and tracking state from the single AR session owner.
11. Document the source timebase and raw ARKit transform semantics and validate 4x4 shape/finiteness.
12. Maintain a bounded pose buffer and bind the nearest eligible pose to each accepted camera-capture timestamp with explicit tolerance/status.
13. Add deterministic tests for out-of-order samples, exact tolerance boundaries, invalid transforms, stale/missing tracking and accepted-capture binding.
