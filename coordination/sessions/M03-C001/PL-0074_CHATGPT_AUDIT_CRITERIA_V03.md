# PL-0074 — ChatGPT Remediation Audit Criteria V03

Task: **PL-0074 — Exposure selected-device/metadata remediation**
Previous audit: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M03-C001/PL-0074_CHATGPT_AUDIT_V02.md
...
9. Make selected-device identity and shared CameraConfigurationCoordinator mandatory for the physical exposure adapter.
10. Bind ExposureCaptureBinding into the accepted PhotoCaptureMetadata construction/persistence path with actual mode/value provenance.
11. Expose metering/locked/unavailable/failure state through the real capture UI/view model.
12. Add tests for wrong-device rejection, serialized configuration, bounds/unsupported lock and accepted-photo metadata persistence.
