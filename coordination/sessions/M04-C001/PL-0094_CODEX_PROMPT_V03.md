# PL-0094 — Codex Remediation Work Order V03
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M04-C001/PL-0094_CODEX_PROMPT_V03.md
...
1. Preserve the current production M04CandidateQualityRuntime integration and corrected sharpness reason codes.
2. Add deterministic candidate-frame fixtures that make SharpnessAnalyzer return WARN and REJECT bands, not only ACCEPT/unavailable.
3. Add exact analyzer equality tests at acceptMinimum and warnMinimum using a production-used injectable metric/fixture seam if exact image construction is impractical.
4. Keep provisional calibration truthfulness and do not claim physical iPhone calibration.
