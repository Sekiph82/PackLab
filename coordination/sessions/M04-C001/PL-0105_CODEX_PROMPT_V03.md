# PL-0105 — Codex Remediation Work Order V03
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M04-C001/PL-0105_CODEX_PROMPT_V03.md
...
1. Preserve authoritative accepted pose bindings and production auto-gate integration.
2. Add same-azimuth / useful-elevation-change behavior.
3. Add exact and just-across boundary tests for maximumTranslationMeters, maximumElevationDifference and maximumSignatureDistance.
4. Preserve fail-safe stale/unavailable pose behavior and immutable prior accepted sources.
