# PL-0102 — Codex Remediation Work Order V03
...
This prompt: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M04-C001/PL-0102_CODEX_PROMPT_V03.md
...
1. Preserve authoritative PoseCaptureBinding-only production coverage input.
2. Add deterministic tests exactly at each configured minimumElevation and maximumElevation boundary and immediately outside those boundaries.
3. Verify ring assignment, invalid observation state, captured totals and missing-sector totals remain deterministic.
4. Preserve stale/unavailable/invalid/mismatched binding rejection.
