# PL-0067 — Codex Work Order V01

Task: **PL-0067 — Synthetic calibration ground-truth tests**
...
Required log: https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M02-C001/PL-0067_CODEX_LOG_V01.md
...
1. Build deterministic synthetic calibration cases with known marker geometry, camera/projective conditions and ground-truth dimensions.
2. Exercise detection/scale/confidence/profile logic without relying on private images.
3. Cover ideal, noisy, partial, degenerate and inconsistent cases with explicit expected error bounds.
4. Ensure tests are sensitivity-bearing and fail when scale math, units or coordinate ordering are intentionally perturbed.
5. Record synthetic-generation parameters/provenance for reproducibility.
