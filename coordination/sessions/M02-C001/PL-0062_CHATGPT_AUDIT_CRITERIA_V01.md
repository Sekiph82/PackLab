# PL-0062 — ChatGPT Strict Audit Criteria V01
...
7. Implement marker detection for the selected dictionary using OpenCV behind a PackLab-owned calibration API is satisfied.
8. Implement deterministic corner refinement and return marker IDs, ordered pixel corners and quality/provenance metadata is satisfied.
9. Reject/flag duplicates, malformed images and unsupported image shapes without crashing unrelated workflows is satisfied.
10. Do not infer physical scale in this detection-only task is satisfied.
11. Use synthetic/generated safe test images where possible and pin behavior to the selected dictionary constants is satisfied.
...
17. The child log exists at https://github.com/Sekiph82/PackLab/blob/main/coordination/sessions/M02-C001/PL-0062_CODEX_LOG_V01.md, links prompt/criteria, records implementation evidence and ends READY_FOR_INDEPENDENT_AUDIT.
